...
Once Node.js and npm are installed download and unzip the CTK-TMF629-CustomerManagement ZIP file within your test directory.
...
>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/customerManagement/v3/customer

You should input:
>>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/customerManagement/v3/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF629-CustomerManagement/blob/master/CTK-TMF629-CustomerManagement/Output-Example.png)
