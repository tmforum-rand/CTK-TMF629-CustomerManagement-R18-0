...
function getURL(){
    ...
    rl.question('////////////////////////////////////////////////////////////////////////\nWhat is your full API address omiting the endpoint? example:\nhttp://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/customerManagement/v3/customer\nbecomes\nhttp://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/customerManagement/v3/\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
