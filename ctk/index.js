...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/customerManagement/v3/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "customer";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF629 CustomerManagement\n");
getURL();
...
function getURL(){
    ...
    rl.question('////////////////////////////////////////////////////////////////////////\nWhat is your full API address omiting the endpoint? example:\nhttps://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/customerManagement/v3/customer\nbecomes\nhttps://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/customerManagement/v3/\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF629-CustomerManagement.postman_collection.json'),
